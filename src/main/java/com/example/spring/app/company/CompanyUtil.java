...
public class CompanyUtil {
    ...
    public static Page<CompanyDtoWithStatusDTO> fillPaginationCompanyDtoWithStatusDto(Page<CompanyModel> companiesPage, List<UserCompanyStatusModel> userCompanyStatuses) {
    ...
    public static CompanyDtoWithStatusDTO fillCompanyDtoWithStatusDto(CompanyDTO companyDTO, UserCompanyStatusModel userCompanyStatus) {
