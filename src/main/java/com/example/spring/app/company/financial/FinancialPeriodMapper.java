...
import com.example.spring.app.company.CompanyModel;
...
public class FinancialPeriodMapper {
    ...
    public static List<FinancialPeriodDTO> toFinancialPeriodDTOList(CompanyModel company) {
    ...
    private static Object invokeGetter(CompanyModel company, String methodName) {
        try {
