...
import static com.example.spring.core.userQuota.UserQuotaUtil.getQuotaBasedOnTier;
...
public class UserResource {
    ...
    /**
     * We should not use this method to create users.
     * The flow is: UserDTO registers via Keycloak registration page,
     * then, when trying to access our services, we redirect them to complete their profile.
     * When user has paid subscription, we update their profile with the webhook from Stripe.
     */
